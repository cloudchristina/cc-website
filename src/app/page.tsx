      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            ...
            { label: 'IaC',        icons: 'terraform,cloudformation', src: null, desc: 'Terraform · CDK · CloudFormation' },
            { label: 'CI/CD',      icons: 'github,githubactions,jenkins,octopusdeploy', src: null, desc: 'GitHub Actions · Jenkins · Octopus' },
